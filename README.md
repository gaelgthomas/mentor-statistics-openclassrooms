...
- [Firefox Add-ons](https://github.com/gael-thomas/Mentor-Statistics-OpenClassRooms/releases/download/1.0/mentor_statistics_openclassrooms-1.0-fx.xpi) - To download extension for Firefox.
